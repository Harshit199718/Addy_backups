...
export const { setDeferredPrompt, toggleSidebar, setGlobalError, changeLanguage, toggleLiveChat, setAutomaticMessagePayload, setUnreadMessages, setNotificationPermission, setNotificationWebMessage, setInnerWidth } = generalSlice.actions;
