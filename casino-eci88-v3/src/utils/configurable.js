export const configurable = {
    ...
    // Image
    logo: require("../assets/images/transparent.jpg"),
    promo_moredetails: require("../assets/images/promotion-btn.jpg"),
    promo_joinnow: require("../assets/images/promotion-join-btn.jpg"),
    vip_ranking: require("../assets/images/vip-ranking.png"), 
    reward_open_box: require("../assets/images/open_box.webp"), 
    reward_close_box: require("../assets/images/close_box.png"), 
    reward_rebates_bg: require("../assets/images/rebates_bg.webp"),

    // Backgrounds with Color and Image Options
    "menusidebar_bg": "#1b1b1b",
    "menusidebar_bg_type": "menusidebar_bg_color",
    "menusidebar_bg_color": "#1b1b1b",
    "layout_card_bg": "#232323",

    // Footer
    "footer_bg": require("../assets/images/header_bg.jpg"),
    "footer_bg_type": "footer_bg",
    "footer_bg_color": require("../assets/images/header_bg.jpg"),

    // Root Background
    "root_bg": require("../assets/images/root_bg.png"),
    "root_bg_type": "root_bg",
    "root_bg_color": require("../assets/images/root_bg.png"),

    // Header Background
    "header_bg": require("../assets/images/header_bg.jpg"),
    "header_bg_color": "red",
    ...
    // CTC Styles
    ctc_bg: require("../assets/images/ctc_bg.gif"),
    ...
    withdraw_title: require("../assets/images/withdraw.webp"),
