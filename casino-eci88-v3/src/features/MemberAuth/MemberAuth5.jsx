...
function MemberAuth5({currentUser, currency_symbol, home_login_btn, home_register_btn, updatedBankDetails, wallet, enable_chips, wallet_deposit, wallet_withdraw, wallet_refresh, country, handleClick, stopAllProducts, isLoading}) {
          ...
          <AuthButtons2>
            <div className="buttons">
              <div className="button">
                <img src={wallet_deposit} alt="" onClick={() => navigate("/deposit")} />
                {/* <p className="button-name">{t("deposit")}</p> */}
              </div>
              <div className="button">
                <img src={wallet_withdraw} alt="" onClick={() => navigate("/withdraw")} />
...
export default withMemberAuth(MemberAuth5)