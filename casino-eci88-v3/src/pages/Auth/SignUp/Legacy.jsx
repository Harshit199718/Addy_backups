...
function Legacy(props, {isLoading, handleRegister, handleVerifyTac, legacyData, errors}) {
      ...
      >
        ...
        <Form allFields={[]} onSubmit={handleSubmit} errors={errors}>
            ...
            <div className="request-otp" style={{display: "flex", alignItems: "center", justifyContent: "space-between", gap: "10px"}}>
                <Input type="text" placeholder="SMS OTP" name="tac" onChange={handleChange} />
...
export default withRegister(Legacy);
