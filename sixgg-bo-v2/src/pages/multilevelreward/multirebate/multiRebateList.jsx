...
import { useGetMultiLevelRewardRebateQuery } from '../../../features/multirewards/multiRewardsApiSlices';
import MultiRebateToolBar from './multiRebateToolBar';
import MultiRebateDetail from './multiRebateDetailList';
import { useTranslation } from 'react-i18next';

const MultiRebateList = () => {
  ...
  const columns = [
    ...
    },
    {
      ...
      align: 'center',
      hidden: PermissionsAuth.checkPermissions('button', 'view_multilevelreward', false),
      render: (record) => <MultiRebateDetail record={record} t={t} />
    },
  ];
  ...
  return (
    ...
    <div>
      <MultiRebateToolBar isLoading={isFetching} t={t} />
      <Table
        rowKey="id"
        columns={columns}
...
export default MultiRebateList;