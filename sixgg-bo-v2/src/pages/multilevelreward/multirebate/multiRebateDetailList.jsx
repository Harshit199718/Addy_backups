...
const MultiRebateDetailForm = ({ record, t }) => {
...
const MultiRebateDetailFormModal = ({ open, onCancel, apiErrors, id, record, t }) => {
...
const MultiRebateDetail = ({ record, t }) => {
    const dispatch = useDispatch(); 
...
export default MultiRebateDetail;