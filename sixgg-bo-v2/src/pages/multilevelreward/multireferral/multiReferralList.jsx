...
import MultiReferralRewardDetail from './multiReferralRewardDetailList';
import PermissionsAuth from '../../../components/permissionAuth';
import MultiReferralToolBar from './multiReferralToolBar';
import ReferenceSiteListingField from '../../../ListingField/ReferenceSiteListingField';
import { useGetMultiLevelRewardReferralQuery } from '../../../features/multirewards/multiRewardsApiSlices';
import { useTranslation } from 'react-i18next';

const MultiReferralRewardList = () => {
  ...
  const columns = [
    ...
    },
    {
      ...
      align: 'center',
      hidden: PermissionsAuth.checkPermissions('list', 'view_multilevelreward', false),
      render: (record) => <MultiReferralRewardDetail record={record} t={t} />
    },
  ];
  ...
  return (
    ...
    <div>
      <MultiReferralToolBar isLoading={isFetching} t={t} />
      <Table
        rowKey="id"
        columns={columns}
...
export default MultiReferralRewardList;