...
const DropTransactionGamesForm = ({ apiErrors, selectedSite, t }) => {
    return (
        <>
            ...
            <Form.Item
                name="amount"
                label={t("common.Drop Transaction Games Amount")}
                validateStatus={apiErrors.amount ? 'error' : ''}
                help={apiErrors.amount}
                rules={[
                {
                    required: true,
                    message: t('requiredmessage.Please input the amount of the drop transaction games'),
                },
                ]}
                hasFeedback
            >
                <InputNumber style={{ width: '100%' }} placeholder={t('requiredmessage.Please input the amount of the drop transaction games')} min={0}/>
            </Form.Item>
            ...
            <Form.Item
                ...
                rules={[
                    {
                        required: true,
                        message: t('requiredmessage.Please input the remark of the drop transaction games'),
                    },
                ]}
                hasFeedback
            >
...
export default DropTransactionGamesForm