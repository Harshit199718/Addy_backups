...
import { useAddSupportsCreditMutation } from '../../../features/support/supportsApiSlices';
...
const AddCredit = ({ id, t }) => {
    const [open, setOpen] = useState(false);
    const [apiErrors, setApiErrors] = useState([])
    const [Create, { isLoading }] = useAddSupportsCreditMutation();
    ...
    try {
      ...
      dispatch(notification({notification_status: 'success', notification_message: t('notisuccess.Credit Added Successfully')}));
      setOpen(false);
    } catch (error) {
