...
import { useGetNoDepositQuery } from '../../../features/report/reportsApiSlices';
...
const ReportNoDeposit = ({}) => {
    ...
    const sheetname = [
        { name: 'nodeposit', tableId: 'nodeposit' },
    ]

    const filename = `${t("report.No Deposit Report")}`
...
export default ReportNoDeposit;