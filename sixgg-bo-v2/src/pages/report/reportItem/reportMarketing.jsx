...
const ReportMarketing = ({}) => {
    ...
    const columns = [
        {
            title: t('report.Marketing Report'),
            children: [
                {
    ...
    const filename = `${t("report.Marketing Report")} ${filters?.fromDate && filters?.fromDate} - ${filters?.toDate && filters?.toDate}`
    const sheetname = [
        { name: 'marketing', tableId: 'marketing' },
    ]
...
export default ReportMarketing;