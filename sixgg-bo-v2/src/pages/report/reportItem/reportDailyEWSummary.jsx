...
import { useGetEWalletSummaryQuery } from '../../../features/report/reportsApiSlices';
import ReportToolBar from '../reportToolBar';
import { useTranslation } from 'react-i18next';

const ReportDailyEWSummary = ({ showToolbar=true }) => {
    ...
    const columns = [
        {
            title: t('report.Ewallet Gateway'),
            children: [
                {
    ...
    const filename = `${t('report.E-Wallet Summary Report')} ${filters?.fromDate && filters?.fromDate} - ${filters?.toDate && filters?.toDate}`
...
export default ReportDailyEWSummary;