...
import { useGetSingleLevelRewardReferralQuery } from '../../../features/rewards/rewardsApiSlices';
import ReferralToolBar from './referralToolBar';
import RewardDetail from './referralRewardDetailList';
...
const ReferralRewardList = () => {
  ...
  const columns = [
    ...
    },
    {
      ...
      render: (record) => <RewardDetail record={record} t={t} />
    },
  ];
  ...
  return (
    ...
    <div>
      <ReferralToolBar isLoading={isFetching} t={t} />
      <Table
        rowKey="id"
        columns={columns}
