...
const RewardDetailForm = ({ record, t }) => {
...
const RewardDetailFormModal = ({ open, onCancel, apiErrors, id, record, t }) => {
  ...
  return (
    ...
    <Modal
      ...
      width={1400}
    >
      <RewardDetailForm id={id} apiErrors={apiErrors} record={record} t={t} />
    </Modal>
  );
};

const RewardDetail = ({ record, t }) => { 
    const dispatch = useDispatch(); 
