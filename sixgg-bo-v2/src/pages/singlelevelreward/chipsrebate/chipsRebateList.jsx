...
import { chipsRebateTtype, filterChipsRebateType } from '../../../customField/customOption';
import ChipsRebateAction from './chipsrebateaction/chipsRebateAction';
...
import ChipsRebateToolBar from './chipsRebateToolBar';
import PermissionsAuth from '../../../components/permissionAuth';
import { useTranslation } from 'react-i18next';

const ChipsRebateList = ( id ) => {
  ...
  const defaultTtype = convertTtypeOption([filterChipsRebateType(t)[0].value, filterChipsRebateType(t)[1].value]);
  ...
  return (
    ...
    <div>
      <ChipsRebateToolBar isLoading={isFetching} t={t} />
        ...
        <Table
          ...
          columns={[
            ...
            },
            {
              ...
              columnKey: 'ttype',
              sorter: true,
              render: (ttype) => <CustomOptionField option={chipsRebateTtype(t)} mappingText={ttype} />
            },
            {
            ...
            ...(shouldShowActionColumn ? [
              {
                ...
                align: 'center',
                width: 225,
                hidden: PermissionsAuth.checkPermissions('button', 'change_reward', false),
                render: (record) => {
                  const { state } = record;
                  if ( state ) {
                    return (
                      <div>
                        <ChipsRebateAction record={record} t={t} />
                      </div>
                    );
                  }
...
export default ChipsRebateList;