...
const { updateUserDepartment, getUserDetails, getUsers, blockUser, addUserToDepartment, changeUserDepartment, getAgentsWithDepartment } = require("../controllers/userController");
